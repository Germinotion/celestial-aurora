...
import auroraDrift from '../Aurora Drift.mp3';
...
const CelestialAurora = () => {
  ...
  // Start audio on first user interaction (browsers require this)
  const startAudio = () => {
  ...
  return (
    <div
      ...
      onClick={startAudio}
    >
      <audio ref={audioRef} src={auroraDrift} preload="auto" />
